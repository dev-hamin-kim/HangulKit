...
struct transformHardConversionTests {
    ...
    func rule23() {
        let current = try! HangulKit.disassembleCompleteCharacter("국")
        let next = try! HangulKit.disassembleCompleteCharacter("밥")
    ...
    func rule24() {
        let current = try! HangulKit.disassembleCompleteCharacter("신")
    ...
    func rule25() {
        let current = try! HangulKit.disassembleCompleteCharacter("넓")
        let next = try! HangulKit.disassembleCompleteCharacter("게")
