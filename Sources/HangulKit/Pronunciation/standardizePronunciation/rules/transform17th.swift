...
extension Hangul {
    ...
    static private func handleChoseongIsㅇ(current: Syllable, next: Syllable) -> (Syllable, Syllable) {
    ...
    static private func handleChoseongIsㅎAndㄷ(current: Syllable, next: Syllable) -> (Syllable, Syllable) {
